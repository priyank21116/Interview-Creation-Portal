...
const ListItem = ({index,item,deleteinterview}) => {
  ...
  return (
    <>
    <div className=' grid grid-cols-3 gap-5 border-2 bg-slate-100 my-4 py-4 border-blue-600  rounded-lg listitem z-10  duration-200'>
      ...
      <div className='flex-cols grid '>
         <button className=' cursor-pointer bg-red-600 h-3/5 w-4/5 my-7 mx-5 border-2 border-gray-200 bg-white rounded-xl shadow-2xl shadow-inner  hover:bg-red-300 active:bg-red-400 focus:outline-none focus:ring focus:ring-red-800  hover:scale-105 duration-200'  onClick={()=>{ setdel(!del) ; deleteinterview(iid);}}>Delete Interview</button>
         <button className='cursor-pointer bg-purple-600 h-3/5 w-4/5 my-7 mx-5 border-2 border-gray-200 bg-white rounded-xl shadow-2xl shadow-inner hover:bg-violet-300 active:bg-violet-400 focus:outline-none focus:ring focus:ring-violet-800  hover:scale-105 duration-200' onClick={()=>( setupdate(!update))}>Update Interview</button>
      </div>
    </div>
